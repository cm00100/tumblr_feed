...
The biggest challenge was the coding.
...
1. How to add the avatar and publish dates
2. How to do the zoomable photo view
...
Just trying to make time to complete the lab.
